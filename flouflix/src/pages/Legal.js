  ...
  return (
    <>
      ...
      <Typography>
        ...
        <a href="https://flouflix-46d80.web.app/" className={classes.link}>
          https://flouflix-46d80.web.app/
        </a>{" "}
      ...
      <Typography>
        <strong>Propriétaire</strong> : SAS FlouFlix Corporation Capital social
        de 2,50€ Numéro de TVA: 42069123456789 – 3 rue des potiers 74000 Annecy
      </Typography>
      <strong>Responsable publication</strong> : FlouFlix – 06 98 76 54 32 10
      <br />
      Le responsable publication est une personne physique ou une personne
      morale.
      <br />
      <strong>Webmaster</strong> : FlouFlix Webmaster – 06 01 23 45 67 89
      <br />
      <strong>Hébergeur</strong> : Firebase – 1 avenue de Firebase 74000 Annecy
      04 50 00 00 23
      <br />
      <strong>Délégué à la protection des données</strong> : FlouFlix –
      Flouxflix@mail.com
      <br />
      <h2>
      ...
      <Typography>
        ...
        responsable du traitement des Données Personnelles est : FlouFlix
        Corporation.{" "}
        <a href="https://flouflix-46d80.web.app/" className={classes.link}>
          https://flouflix-46d80.web.app/
        </a>
        est représenté par Flouflix, son représentant légal
      </Typography>
      <Typography>
      ...
      FlouFlix Corporation – DPO, FlouFlix <br />3 rue des potiers 74000 Annecy.
      <Typography>
